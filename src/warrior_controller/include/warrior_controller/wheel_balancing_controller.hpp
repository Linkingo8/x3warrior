...
#ifdef NO_SIMULATION
/// left leg go1 param
#define GO1_0_ZEROS 6.244f
#define GO1_3_ZEROS 0.691f
/// right leg go1 param
#define GO1_1_ZEROS 4.44f
#define GO1_2_ZEROS 5.381f
/// leg common range
#define MAX_L0 0.20
#define MIN_L0 0.11
...
namespace warrior_controller
{
    ...
    private:
        ...
        uint8_t machine_balance_flag_ = 0;
        ...
        struct rc_commmonds
        {
            ...
            uint8_t sw_r;
            float wheel;
            rc_commmonds() : ch_l_x(0.0), ch_l_y(0.0), ch_r_x(0.0), ch_r_y(0.13), sw_l(1), sw_r(1), wheel(0) {}
        };
        /* balance controller */
        struct state_variables
        {
            ...
            double fai;
            double fai_dot;
            state_variables() : x(0), x_dot(0), theta_now(0), theta_last(0), theta_dot(0), fai(0), fai_dot(0) {}
        };
        ...
        std::shared_ptr<PID> left_Fy_pid_;
        std::shared_ptr<PID> right_Fy_pid_;
