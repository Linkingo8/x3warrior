  ...
  const hardware_interface::HardwareInfo & info)
{
    ...
    RCLCPP_FATAL(rclcpp::get_logger("Go1HardwareInterface"),"Go1_LF_id '%x' ",GO1_LF_ID_);
    ...
    RCLCPP_FATAL(rclcpp::get_logger("Go1HardwareInterface"),"Go1_LB_id '%x' ",GO1_LB_ID_);
    ...
    RCLCPP_FATAL(rclcpp::get_logger("Go1HardwareInterface"),"Go1_RF_id '%x' ",GO1_RF_ID_);
    ...
    RCLCPP_FATAL(rclcpp::get_logger("Go1HardwareInterface"),"Go1_LF_id '%x' ",GO1_RB_ID_);
